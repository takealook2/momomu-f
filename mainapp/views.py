...
def musical(request):
    return render(request, ('rank.html', 'first.html'), {'title1':title1, 'title2':title2, 'title3':title3,'title4':title4, 'title5':title5, 'title6':title6, 'title7':title7, 'title8':title8, 'title9':title9, 'title10':title10,
